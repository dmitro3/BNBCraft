...
const LightControls = ({ stateEnv, setStateEnv }) => {
  ...
  const handleCurrentLightChange = (value) => {
    ...
    const light = objectMaster.find((object) => object.assetIdentifier === value);
    ...
    switch (name) {
      ...
      case "positionX":
        setCurrentLight(
          {
            ...currentLight,
            position: new THREE.Vector3(Number(value), currentLight.position.y, currentLight.position.z),
          }
        )
        break;
      ...
      case "positionY":
        setCurrentLight(
          {
            ...currentLight,
            position: new THREE.Vector3(currentLight.position.x, Number(value), currentLight.position.z),
          }
        )
        break;
      ...
      case "positionZ":
        setCurrentLight(
          {
            ...currentLight,
            position: new THREE.Vector3(currentLight.position.x, currentLight.position.y, Number(value)),
          }
        )
        break;
  ...
  return (
    <div className="accordion-item standard-fbutton">
      <h2 className="accordion-header">
        <button className="accordion-button standard-background collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
        <span className="me-2 align-middle bi bi-lightbulb-fill text-warning"></span>
          Light {"(" + (currentLightIdentifer ? currentLightIdentifer : "None Selected") + ")"}
        </button>
      </h2>
        ...
        <div className="accordion-body">
          <div className='row m-0 p-0 mb-2'>
            <div className='col-12 mb-2 text-end border border-success p-2 px-3 rounded shadow-sm'>
              ...
              <input type="text" className="form-control" id="lightAssetIdentifier" placeholder="Asset Identifier" value={addLight.assetIdentifier} onChange={(e) => setAddLight({ ...addLight, assetIdentifier: e.target.value })} />
              <button type="button" className="btn btn-primary mt-2" onClick={() => dispatch({ type: "ADD_LIGHT", payload: addLight })}>Add Light</button>
              <div className="form-text text-start">Note: Change Values through dropdown </div>
            </div>
          </div>

          <div className='col-12 mb-2'>
            <label htmlFor="lightType" className="form-label">Light Objects</label>
            <select
          ...
          <div className='col-12'>
            ...
            <label htmlFor="lightAssetIdentifier" className="form-label">Asset Identifier</label>
            <input
              type="text"
              ...
              onChange={(e) => handleLightChange("assetIdentifier", e.target.value)}
            />
          </div>
          ...
          <div className='col-12 mb-2'>
            ...
            <div className="row m-0 p-0">
              <div className="col-4">
                <label htmlFor="lightPositionX" className="form-label
                  ">X</label>
                <input
                  type="number"
                  className="form-control"
                  ...
                  onChange={(e) => handleLightChange("positionX", e.target.value)}
                />
              </div>
              <div className="col-4">
                <label htmlFor="lightPositionY" className="form-label
                  ">Y</label>
                <input
                  type="number"
                  className="form-control"
                  ...
                  onChange={(e) => handleLightChange("positionY", e.target.value)}
                />
              </div>
              <div className="col-4">
                <label htmlFor="lightPositionZ" className="form-label
                  ">Z</label>
                <input
                  type="number"
                  className="form-control"
                  ...
                  onChange={(e) => handleLightChange("positionZ", e.target.value)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="col-12">
            <label htmlFor="lightColor" className="form-label">Color</label>
            <input
              type="color"
              className="form-control"
              id="lightColor"
          ...
          <div className="col-12">
            <label htmlFor="lightIntensity" className="form-label">Intensity</label>
            <input
              type="number"
              className="form-control"
              id="lightIntensity"
